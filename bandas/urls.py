...
from .views import home, crear_banda, about, listado_bandas, buscar, eliminar_bandas, mostrar_bandas, EditarBanda
...
urlpatterns = [
    ...
    path('editar-bandas/<int:id>/', editar_banda, name='editar_bandas'),
